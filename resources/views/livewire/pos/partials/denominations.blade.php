                ...
                <div class="row">
                    @foreach ($denominations as $denomination )
                        <div class="col-sm mt-2">
                            <button class="btn btn-dark btn-block den" wire:click.prevent='ACash({{$denomination->value}})'>
                    ...
                    <div class="card-body">
                        <div class="input-group input-group-md mb-3">
                            ...
                            <div class="input-group-append">
                                <span class="input-group text" wire:click="$set('efectivo',0)" style="background: #3b3f5c; color:white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="54" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-delete" style="margin-top: 12px"><path d="M21 4H8l-7 8 7 8h13a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path><line x1="18" y1="9" x2="12" y2="15"></line><line x1="12" y1="9" x2="18" y2="15"></line></svg>
                                </span>
                            </div>
                        </div>
                        <h4 class="text-muted">Cambio: ${{$change}}</h4>
