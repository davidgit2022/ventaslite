                            ...
                            <tr>
                                <td class="text-center table-th">
                                    @if (count($item->attributes) > 0)
                                        <span>
                                            <img src="{{asset('storage/products/' . $item->attributes[0])}}" alt="imágen del producto" height:90px width="90px" class="rounded">
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="text-center">
                                    <button onclick="Confirm('{{$item->id}}','revomeItem', '¿CONFIRMAS ELIMINAR EL REGISTRO?')" class="btn btn-dark mbmobile">
